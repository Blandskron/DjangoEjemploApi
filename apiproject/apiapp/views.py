...
def item_list(request):
    ...
    return render(request, 'apiapp/item_list.html', {'items': items})
...
def item_create(request):
    if request.method == 'POST':
        ...
        form = Inventarios()
    return render(request, 'apiapp/item_form.html', {'form': form})
...
def item_delete(request, pk):
    ...
    if request.method == 'POST':
        item.delete()
        return redirect('item_list')
    return render(request, 'apiapp/item_confirm_delete.html', {'item': item})